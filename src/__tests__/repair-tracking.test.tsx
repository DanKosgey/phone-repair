// src/__tests__/repair-tracking.test.tsx
...
describe('Repair Tracking Feature Toggle', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  test('should show TrackTicketCTA when tracking feature is enabled', async () => {
    // Mock the hook to return tracking feature enabled
    ...
    // Check that the TrackTicketCTA is rendered
    expect(screen.getByTestId('track-ticket-cta')).toBeInTheDocument();
  });

  test('should hide TrackTicketCTA when tracking feature is disabled', async () => {
    ...
    // Check that the TrackTicketCTA is not rendered
    expect(screen.queryByTestId('track-ticket-cta')).not.toBeInTheDocument();
  });

  test('should only hide TrackTicketCTA when tracking is disabled but other features remain', async () => {
