-- Migration 026: Update dashboard views to include paid-only revenue metrics
-- Description: Add paid_repair_revenue and paid_product_revenue fields to admin_dashboard_metrics view
